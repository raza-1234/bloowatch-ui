            ...
            <React.Fragment>
              <li className='bloowatch-header__cart-item'>
                <Link className = "bloowatch-header__nav-list-item" to = "/cart" onClick={() => setMobileMenu(false)}>
                  <Badge data-testid = "cartBadge" showZero count = {cart?.cartCount}>
              ...
              <li className='bloowatch-header__dropdown'>
                ...
                {
                  showDropDown &&
                  <div data-testid = "dropDown" className="bloowatch-header__dropdown-content">
              ...
              {
                showDropDown &&
                <div data-testid = "screen_wrapper" onClick={() => setShowDropDown(!showDropDown)} className='bloowatch-screen__wrapper'/>
              }
            </React.Fragment>
            :
            <React.Fragment>
